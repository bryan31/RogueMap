...
public class BM25IndexTest {
    ...
    public void addAndSearch() {
        ...
        List<BM25Index.ScoredOrdinal> results = index.search("hello", 10);
    ...
    public void emptyQuery() {
        ...
        List<BM25Index.ScoredOrdinal> results = index.search("", 10);
    ...
    public void unknownTerm() {
        ...
        List<BM25Index.ScoredOrdinal> results = index.search("unknown", 10);
        assertTrue(results.isEmpty());
    }
    ...
    public void serializeDeserialize() throws Exception {
        ...
        List<BM25Index.ScoredOrdinal> results = restored.search("hello", 10);
        assertEquals(2, results.size());
    }
